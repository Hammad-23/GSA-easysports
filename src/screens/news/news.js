...
export default function News(){
    return(
        ...
        <Header/>
        <ScrollView>
            <ImageBackground style={style.imgBg} source={require('../../assets/news/news-bg.jpg')}>
             <View style={{alignItems:"center",marginTop:20}}>
                 <Text style={style.heading}>NEWS</Text>
                 <Text style={{color:"#FFFF",fontWeight:"bold"}}>ALLES RUND UM GESUNDHEIT UND ATHLETIK</Text>
             </View>
             <TouchableOpacity style={style.newsCards}>
              ...
              <ImageBackground style={style.newsBtn} source={require('../../assets/news/news-btn.png')}>
